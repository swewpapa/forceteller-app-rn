import { normalizeThemes } from '@/features/theme/api/normalize-themes';
  ...
  themeViews: [
    {
      ...
      viewId: 133763,
      type: 'item',
      title: '연애로 본 내 숨겨진 욕망',
      subtitle: null,
      thumbnail_image: 'https://static.example.com/a.jpg',
      full_image: '',
      label_text: '사주',
      label_color: '#DE8064',
      isNew: false,
...
const rawKeywordCloud = {
  id: 8,
  uuid: 'd8161dc4-71b4-4a11-8ac7-9603348de9ca',
  code: 'recommend_top',
  type: 'keyword_cloud',
  title: '예지 꿈 해몽',
  subtitle: '무서운 꿈을 꾸었구나',
  themeViews: [
    {
      id: -1,
      viewId: 2669,
      ...
      keywords: [
        {
          text: '바다',
          link: { type: 'url', value: '/dream', params: { queryParams: { keyword: '바다' } } },
        },
...
describe('normalizeThemes', () => {
  it('text_only 위젯을 views와 함께 매핑한다', () => {
    ...
    expect(w.views[0]).toEqual({
      ...
      title: '연애로 본 내 숨겨진 욕망',
      subtitle: null,
      label: { text: '사주', color: '#DE8064' },
      thumbnailImage: 'https://static.example.com/a.jpg',
      fullImage: null,
      link: { type: 'url', value: '/item/1837' },
      isNew: false,
    });
    ...
    expect(w.keywords).toEqual([
      {
        text: '바다',
        isMore: false,
        link: { type: 'url', value: '/dream', queryParams: { keyword: '바다' } },
      },
      ...
      normalizeThemes([
        {
          ...
          subtitle: '',
          themeViews: [
            { id: -1, viewId: 2669, keywords: [{ text: '링크없음1' }, { text: '링크없음2' }] },
          ],
        },
      ]),
    ).toEqual([]);
    ...
    const [w] = normalizeThemes([
      {
        ...rawTextOnly,
        themeViews: [
          { id: 1, viewId: 1, title: 't', label_text: '사주', link: { type: 'url', value: '/x' } },
        ],
      },
    ]);
    if (w.type !== 'text_only') throw new Error('unreachable');
