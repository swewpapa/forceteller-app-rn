...
import { Column, ScreenContainer, AppBar, type AppBarAction } from '@/shared/components';
...
export function HomeScreen() {
  ...
  return (
    <ScreenContainer>
      ...
      <AppBar actions={['search', 'freeForce', 'calendar']} onPressAction={handleAppBarAction} />
      <ScrollView>
